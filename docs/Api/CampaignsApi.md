...
# **campaigns**
> \IterableIA\Model\CampaignsResponse campaigns()
...
$apiInstance = new IterableIA\Api\CampaignsApi(
...
[**\IterableIA\Model\CampaignsResponse**](../Model/CampaignsResponse.md)
...
# **childCampaigns**
> \IterableIA\Model\CampaignsResponse childCampaigns($id)
...
# **createCampaign**
> \IterableIA\Model\CreateCampaignResponse createCampaign($body)
...
$body = new \IterableIA\Model\CreateCampaignRequest(); // \IterableIA\Model\CreateCampaignRequest | Create campaign
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\IterableIA\Model\CreateCampaignRequest**](../Model/CreateCampaignRequest.md)| Create campaign |

### Return type

[**\IterableIA\Model\CreateCampaignResponse**](../Model/CreateCampaignResponse.md)
...
# **triggerCampaign**
> \IterableIA\Model\IterableApiResponse triggerCampaign($body)
...
$body = new \IterableIA\Model\TriggerCampaignRequest(); // \IterableIA\Model\TriggerCampaignRequest | Trigger campaign
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\IterableIA\Model\TriggerCampaignRequest**](../Model/TriggerCampaignRequest.md)| Trigger campaign |
