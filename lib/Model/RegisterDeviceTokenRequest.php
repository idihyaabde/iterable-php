 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RegisterDeviceTokenRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegisterDeviceTokenRequest';
...
'prefer_user_id' => 'getPreferUserId'    ];
     ...
     * Sets user_id
     *
     * @param string $user_id Register device for a user with specified userId. Either email or userId must be specified.
     *
     * @return $this
     */
