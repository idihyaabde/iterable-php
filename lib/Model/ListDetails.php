 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListDetails';
...
const LIST_TYPE_DYNAMIC = 'Dynamic';
const LIST_TYPE_SUPPRESSION = 'Suppression';
const LIST_TYPE_INTERNAL = 'Internal';
    ...
    {
        return [
            self::LIST_TYPE_STANDARD,
self::LIST_TYPE_DYNAMIC,
self::LIST_TYPE_SUPPRESSION,
self::LIST_TYPE_INTERNAL,        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['list_type']) && !in_array($this->container['list_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'list_type', must be one of '%s'",
