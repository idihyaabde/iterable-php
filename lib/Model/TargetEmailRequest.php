...
/**
 * TargetEmailRequest Class Doc Comment
 *
 * @category Class
 * @package  IterableIA
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TargetEmailRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TargetEmailRequest';
...
'metadata' => 'getMetadata'    ];
     ...
     * Sets send_at
     *
     * @param string $send_at Schedule the message for up to 365 days in the future. If set in the past, email is sent immediately. Format is YYYY-MM-DD HH:MM:SS in UTC
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param object $metadata Metadata to pass back via webhooks. Not used for rendering
     *
     * @return $this
     */
