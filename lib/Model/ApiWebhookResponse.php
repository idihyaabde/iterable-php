...
/**
 * ApiWebhookResponse Class Doc Comment
 *
 * @category Class
 * @package  IterableIA\Iterable
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApiWebhookResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiWebhookResponse';
...
'blast_send_enabled' => 'getBlastSendEnabled'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['triggered_send_enabled'] === null) {
            $invalidProperties[] = "'triggered_send_enabled' can't be null";
        }
        if ($this->container['blast_send_enabled'] === null) {
            $invalidProperties[] = "'blast_send_enabled' can't be null";
        }
